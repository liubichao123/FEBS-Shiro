...
CREATE TABLE `t_log` (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1013 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='操作日志表';
...
INSERT INTO `t_log` VALUES ('1008', 'mrbird', '删除菜单/按钮', '29', 'cc.mrbird.febs.system.controller.MenuController.deleteMenus()', ' menuIds: \"137,138,139\"', '10.0.51.195', '2019-08-22 10:01:35', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES ('1009', 'mrbird', '删除菜单/按钮', '47', 'cc.mrbird.febs.system.controller.MenuController.deleteMenus()', ' menuIds: \"176,177\"', '10.0.51.195', '2019-08-22 10:01:48', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES ('1010', 'mrbird', '新增菜单/按钮', '23', 'cc.mrbird.febs.system.controller.MenuController.addMenu()', ' menu: \"Menu(menuId=178, parentId=0, menuName=数据展示, url=, perms=, icon=layui-icon-funnelplot, type=0, orderNum=null, createTime=Thu Aug 22 10:02:47 CST 2019, modifyTime=null)\"', '10.0.51.195', '2019-08-22 10:02:48', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES ('1011', 'mrbird', '新增菜单/按钮', '71', 'cc.mrbird.febs.system.controller.MenuController.addMenu()', ' menu: \"Menu(menuId=179, parentId=178, menuName=基本数据, url=www.baidu.com, perms=, icon=, type=0, orderNum=null, createTime=Thu Aug 22 10:03:24 CST 2019, modifyTime=null)\"', '10.0.51.195', '2019-08-22 10:03:25', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES ('1012', 'mrbird', '修改角色', '29', 'cc.mrbird.febs.system.controller.RoleController.updateRole()', ' role: \"Role(roleId=1, roleName=系统管理员, remark=系统管理员，拥有所有操作权限 ^_^, createTime=null, modifyTime=Thu Aug 22 10:04:10 CST 2019, menuIds=178,1,3,11,12,13,160,161,4,14,15,16,162,5,17,18,19,163,6,20,21,22,164,2,8,23,10,24,170,136,171,172,113,114,127,128,129,130,131,175,101,102,103,104,105,106,107,108,173,109,110,174,115,132,133,135,134,126,159,116,117,119,120,121,122,123,118,125,167,168,169)\"', '10.0.51.195', '2019-08-22 10:04:10', '内网IP|0|0|内网IP|内网IP');
...
CREATE TABLE `t_login_log` (
  ...
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='登录日志表';
...
INSERT INTO `t_login_log` VALUES ('70', 'mrbird', '2019-08-21 20:48:04', '内网IP|0|0|内网IP|内网IP', '10.0.51.12', 'Windows 10', 'Chrome 74');
INSERT INTO `t_login_log` VALUES ('71', 'mrbird', '2019-08-22 09:46:27', '内网IP|0|0|内网IP|内网IP', '10.0.51.195', 'Windows 10', 'Firefox 68');
INSERT INTO `t_login_log` VALUES ('72', 'mrbird', '2019-08-22 09:51:21', '内网IP|0|0|内网IP|内网IP', '10.0.51.158', 'Windows 10', 'Chrome 74');
INSERT INTO `t_login_log` VALUES ('73', 'mrbird', '2019-08-22 09:59:27', '内网IP|0|0|内网IP|内网IP', '10.0.51.195', 'Windows 10', 'Firefox 68');
INSERT INTO `t_login_log` VALUES ('74', 'mrbird', '2019-08-22 10:05:01', '内网IP|0|0|内网IP|内网IP', '10.0.51.195', 'Windows 10', 'Firefox 68');
INSERT INTO `t_login_log` VALUES ('75', 'mrbird', '2019-08-22 10:07:16', '内网IP|0|0|内网IP|内网IP', '10.0.51.126', 'Windows ', 'Chrome 70');
INSERT INTO `t_login_log` VALUES ('76', 'mrbird', '2019-08-22 10:07:25', '内网IP|0|0|内网IP|内网IP', '10.0.51.195', 'Windows 10', 'Firefox 68');
INSERT INTO `t_login_log` VALUES ('77', 'mrbird', '2019-08-22 10:07:29', '内网IP|0|0|内网IP|内网IP', '10.0.51.233', 'Windows 10', 'Firefox 69');
INSERT INTO `t_login_log` VALUES ('78', 'mrbird', '2019-08-22 10:07:57', '内网IP|0|0|内网IP|内网IP', '10.0.51.94', 'Windows ', 'Chrome 74');
INSERT INTO `t_login_log` VALUES ('79', 'mrbird', '2019-08-22 10:23:52', '内网IP|0|0|内网IP|内网IP', '10.0.51.233', 'Windows 10', 'Firefox 69');
INSERT INTO `t_login_log` VALUES ('80', 'mrbird', '2019-08-22 10:34:06', '内网IP|0|0|内网IP|内网IP', '10.0.51.12', 'Windows 10', 'Chrome 69');
INSERT INTO `t_login_log` VALUES ('81', 'mrbird', '2019-08-22 10:36:49', '内网IP|0|0|内网IP|内网IP', '10.0.51.195', 'Windows 10', 'Firefox 68');
INSERT INTO `t_login_log` VALUES ('82', 'mrbird', '2019-08-22 10:37:06', '内网IP|0|0|内网IP|内网IP', '10.0.51.195', 'Windows 10', 'Firefox 68');
INSERT INTO `t_login_log` VALUES ('83', 'mrbird', '2019-08-22 10:37:12', '内网IP|0|0|内网IP|内网IP', '10.0.51.12', 'Windows 10', 'Chrome 69');
...
) ENGINE=InnoDB AUTO_INCREMENT=180 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单表';
...
INSERT INTO `t_menu` VALUES ('178', '0', '数据展示', '', '', 'layui-icon-funnelplot', '0', null, '2019-08-22 10:02:48', null);
INSERT INTO `t_menu` VALUES ('179', '178', '基本数据', 'www.baidu.com', '', '', '0', null, '2019-08-22 10:03:25', null);
...
-- Records of t_role
-- ----------------------------
INSERT INTO `t_role` VALUES ('1', '系统管理员', '系统管理员，拥有所有操作权限 ^_^', '2019-06-14 16:23:11', '2019-08-22 10:04:10');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', 'mrbird', 'b9a81e45893e814679a13d79e4617dfd', '1', 'mrbird@qq.com', '17788888888', '1', '2019-06-14 20:39:22', '2019-06-14 20:44:42', '2019-08-22 10:37:13', '0', '1', 'white', 'cnrhVkzwxjPwAaCfPbdc.png', '我是帅比作者。');
...
INSERT INTO `t_user` VALUES ('8', 'admin', '856aea89ad509f163284abb75579dcfc', null, null, null, '1', '2019-08-21 20:37:51', null, null, '2', '1', 'black', 'default.jpg', '注册用户');
